...
use Cz\I18Bundle\Entity\Lang;
use Cz\I18Bundle\Form\LangType;
...
class LangController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $langs = $em->getRepository('CzI18Bundle:Lang')->findAll();
    ...
    {
        $lang = new Lang();
        $form = $this->createForm('Cz\I18Bundle\Form\LangType', $lang);
    ...
    {
        $deleteForm = $this->createDeleteForm($lang);
        $editForm = $this->createForm('Cz\I18Bundle\Form\LangType', $lang);
