<?php
namespace Cz\ManagerBundle\Helper\Images;
...
class FileUploader
{
    ...
    public function __construct(EntityManager $em, RequestStack $requestStack, ValidatorInterface $validator, Kernel $kernel)
    {
        $this->em = $em;
