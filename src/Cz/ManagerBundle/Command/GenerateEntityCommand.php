...
namespace Cz\ManagerBundle\Command;

use Cz\ManagerBundle\Generator\Helper\GeneratorUtils;
use Sensio\Bundle\GeneratorBundle\Command\Validators;
use Cz\ManagerBundle\Generator\DoctrineEntityGenerator;
...
class GenerateEntityCommand extends GenerateDoctrineCommand
{
    ...
    protected function configure()
    {
        $this
            ...
            ->setHelp(<<<EOT
The <info>cz:generate:entity</info> task generates a new Doctrine
entity inside a bundle:

<info>php app/console cz:generate:entity --entity=AcmeBlogBundle:Blog/Post</info>
...
<info>php app/console cz:generate:entity --entity=AcmeBlogBundle:Blog/Post --fields="title:string(255) body:text"</info>

The command can also generate the corresponding entity repository class with the
<comment>--with-repository</comment> option:

<info>php app/console cz:generate:entity --entity=AcmeBlogBundle:Blog/Post --with-repository</info>

Use the <info>--prefix</info> option to add a prefix to the table names of the generated entities

<info>php app/console cz:generate:entity --entity=AcmeBlogBundle:Blog/Post --prefix=demo_</info>

To deactivate the interaction mode, simply use the `--no-interaction` option
without forgetting to pass all needed options:

<info>php app/console cz:generate:entity --entity=AcmeBlogBundle:Blog/Post --fields="title:string(255) body:text" --with-repository --no-interaction</info>
EOT
            );
    }
    ...
    $questionHelper = $this->getQuestionHelper();
        ...
        $generator = $this->getGenerator($this->getApplication()->getKernel()->getBundle("CzManagerBundle"));
