...
use Cz\AdminBundle\Entity\Page;
use Cz\AdminBundle\Form\PageType;
...
class PageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $pages = $em->getRepository('CzAdminBundle:Page')->findAll();
    ...
    {
        $page = new Page();
        $form = $this->createForm('Cz\AdminBundle\Form\PageType', $page);
    ...
    {
        $deleteForm = $this->createDeleteForm($page);
        $editForm = $this->createForm('Cz\AdminBundle\Form\PageType', $page);
